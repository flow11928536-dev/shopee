...
export default function FabricantesGrid({ fabricantes }: { fabricantes: Fabricante[] }) {
          ...
          {filtrados.map((fab, index) => (
            ...
            >
              ...
              <div className="mb-4 flex items-start justify-between gap-3 pt-2">
                <div className="flex h-14 w-24 items-center justify-start">
                  {fab.logo ? (
                    <Image
                      src={fab.logo}
                      alt={`Logo ${fab.nome}`}
                      width={110}
                      height={36}
                      className="h-9 w-auto object-contain opacity-80 grayscale transition-all duration-300 group-hover:opacity-100 group-hover:grayscale-0"
                    />
                  ) : (
                    <span
              ...
              <div className="flex gap-2">
                ...
                <Link
                  href={`/buscar?q=${encodeURIComponent(fab.nome)}`}
