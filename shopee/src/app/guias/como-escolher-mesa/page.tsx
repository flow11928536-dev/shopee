...
export const metadata: Metadata = {
  ...
  description: "Guia de montador 27 anos: mesa 4 cadeiras 120-140cm precisa 3x2m, mesa 6 cadeiras 160-180cm precisa 3,5x2,5m. Altura 75-77cm, 75cm circulaÃ§Ã£o, MDF 25mm vs madeira macica. Veja mesa jantar + cadeiras + banquetas Slim Confort.",
  alternates: { canonical: `${SITE.url}/guias/como-escolher-mesa` },
  openGraph: {
    title: "Como Escolher Mesa de Jantar 4 e 6 Cadeiras - Guia 2026",
    description: "Medida certa para 4 e 6 cadeiras, espaÃ§o mÃ­nimo, material que nÃ£o estufa e altura ideal. Com vÃ­deo de montador.",
    url: `${SITE.url}/guias/como-escolher-mesa`,
    type: "article",
    images: [{ url: `${SITE.url}/banners/og-image.jpg`, width: 1200, height: 630, alt: "Como Escolher Mesa de Jantar 4 e 6 Cadeiras" }],
  },
};

const universidades = [
  { nome: "UNIMAR", cidade: "MarÃ­lia", sigla: "UNIMAR", curso: "Medicina" },
  { nome: "UNESP MarÃ­lia", cidade: "MarÃ­lia", sigla: "UNESP", curso: "Filosofia" },
  { nome: "FAMEMA", cidade: "MarÃ­lia", sigla: "FAMEMA", curso: "Medicina" },
  { nome: "UNIVEM", cidade: "MarÃ­lia", sigla: "UNIVEM", curso: "Direito" },
  { nome: "FIB Bauru", cidade: "Bauru", sigla: "FIB", curso: "Engenharia" },
];

const faqs = [
  { q: "Qual medida ideal para mesa de 4 cadeiras?", a: "120x80cm a 140x80cm. Ocupa 3m x 2m com circulaÃ§Ã£o de 75cm para puxar a cadeira. Cabe em apartamento 50mÂ²." },
  { q: "Qual medida ideal para mesa de 6 cadeiras?", a: "160x90cm a 180x90cm. Precisa 3,5m x 2,5m de sala. 180cm Ã© melhor, cada pessoa tem 60cm de largura." },
  { q: "Mesa redonda ou retangular?", a: "Retangular: aproveita mais espaÃ§o e cabe 6. Redonda 120cm: sÃ³ para 4 pessoas, mas conversa melhor. Quadrada 90cm: sÃ³ kitnet, 2 pessoas." },
  { q: "MDF ou madeira macica?", a: "MDF 25mm com BP: aguenta 5 anos se nÃ£o molhar, R$400-700. Madeira macica: dura 15 anos, nÃ£o estufa, R$1200+. Vidro: bonita mas marca dedo e pesa." },
...
const MESA_6_CADEIRAS = [
  ...
  "conjunto-sala-jantar-mesa-vidro-170cm-6-cadeiras-genova-cel-moveis", // Genova 170cm vidro 6 cadeiras Cel MÃ³veis - R$1814 - 4.7
  "conjunto-sala-jantar-mesa-vidro-170cm-6-cadeiras-napoles-cel-moveis", // NÃ¡poles 170cm vidro 6 cadeiras LuÃ­sa - R$1454 - 4.7 - 243 reviews
];
...
export default function Page() {
  const jsonLd = {
    ...
    description: "Medidas certas para 4 e 6 cadeiras, espaÃ§o mÃ­nimo e material que nÃ£o estufa.",
    author: { "@type": "Organization", name: "Loja de MÃ³veis MarÃ­lia", url: SITE.url },
    publisher: { "@type": "Organization", name: "Loja de MÃ³veis MarÃ­lia", logo: { "@type": "ImageObject", url: `${SITE.url}/loja-moveis-jardim-esmeralda-marilia-moveis-de-alto-padrao-marilia-logo.png` } },
  ...
  const videoSchema = {
    ...
    description: "Como escolher mesa de jantar 4 e 6 cadeiras na Shopee, medidas certas e modelos indicados por montador com 27 anos de experiÃªncia.",
    ...
    <>
      ...
      <article className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <header className="mb-8">
          ...
          <p className="mt-4 text-lg text-stone-600">Mesa Ã© mesa, mas 4 cadeiras precisa 120-140cm e 3x2m de sala. 6 cadeiras precisa 160-180cm e 3,5x2,5m. Altura 75-77cm. Vou te mostrar como medir e qual material nÃ£o estufa.</p>
          <p className="mt-2 text-xs text-stone-400">Atualizado em {MODIFIED_DATE} - MarÃ­lia-SP</p>
        </header>
        ...
        <section className="mt-10 rounded-3xl bg-amber-50 p-6 sm:p-8 border border-amber-200">
          <h2 className="text-xl font-bold text-stone-900 sm:text-2xl">ðŸ“ Medida Certa: 4 vs 6 Cadeiras</h2>
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl bg-white p-5 shadow-sm border">
              ...
              <ul className="mt-3 text-sm text-stone-600 list-disc pl-4 space-y-1">
                <li>Sala mÃ­nima: 3m x 2m</li>
                <li>Apartamento 50mÂ² cabe tranquilo</li>
            ...
            <div className="rounded-2xl bg-stone-900 p-5 shadow-sm text-white border border-stone-800">
              ...
              <ul className="mt-3 text-sm text-stone-300 list-disc pl-4 space-y-1">
                <li>Sala mÃ­nima: 3,5m x 2,5m</li>
                <li>180cm Ã© melhor: sobra espaÃ§o</li>
                <li>Cabe 6 e ainda recebe visita</li>
                <li>FamÃ­lia que recebe no domingo</li>
              </ul>
            </div>
          </div>
          <div className="mt-4 rounded-xl bg-white p-4 border border-amber-200">
            <p className="text-sm font-semibold text-stone-900">âš ï¸ Regra de ouro do montador:</p>
            <p className="text-sm text-stone-600 mt-1">Deixe <strong>75cm atrÃ¡s da cadeira</strong> para puxar e levantar. Sem isso a pessoa fica presa. MeÃ§a da parede atÃ© onde vai a mesa + 75cm. Se nÃ£o tiver, compre 4 cadeiras, nÃ£o 6.</p>
          </div>
        </section>
        ...
        <section className="mt-10 grid gap-6 sm:grid-cols-2">
          <div className="rounded-3xl border border-stone-200 p-6">
            ...
            <p className="mt-2 text-sm text-stone-600">PadrÃ£o ABNT. Cadeira estofada tem assento 45cm. Sobra 30cm para perna. Abaixo de 74cm sua coxa bate na mesa. Acima de 78cm ombro fica tenso. Teste: cotovelo a 90Â° sobre a mesa.</p>
          </div>
          <div className="rounded-3xl border border-stone-200 p-6">
            ...
            <ul className="mt-2 text-sm text-stone-600 space-y-1">
              ...
              <li><strong>Redonda 120cm:</strong> para 4 pessoas, conversa melhor, sem quina pra crianÃ§a bater</li>
              <li><strong>Quadrada 90cm:</strong> sÃ³ kitnet, 2 pessoas, nÃ£o compre 6</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mt-10">
          <h2 className="text-xl font-bold text-stone-900 sm:text-2xl">ðŸªµ Material: Qual nÃ£o estufa em 1 ano?</h2>
          <div className="mt-4 overflow-x-auto rounded-2xl border">
            <table className="w-full text-sm">
              <thead className="bg-stone-100"><tr><th className="px-4 py-3 text-left">Material</th><th className="px-4 py-3 text-left">Dura</th><th className="px-4 py-3 text-left">PreÃ§o</th><th className="px-4 py-3 text-left">Cuidado</th></tr></thead>
              <tbody className="divide-y">
                <tr><td className="px-4 py-3 font-medium">MDF 15mm</td><td className="px-4 py-3">1-2 anos</td><td className="px-4 py-3">R$300-500</td><td className="px-4 py-3 text-red-600">Entorta, nÃ£o compre</td></tr>
                <tr><td className="px-4 py-3 font-medium">MDF 25mm BP</td><td className="px-4 py-3">5 anos</td><td className="px-4 py-3">R$500-800</td><td className="px-4 py-3">NÃ£o molhar, boa</td></tr>
                <tr className="bg-amber-50"><td className="px-4 py-3 font-bold">Madeira Macica</td><td className="px-4 py-3 font-bold">15 anos+</td><td className="px-4 py-3 font-bold">R$1200+</td><td className="px-4 py-3">Melhor, nÃ£o estufa</td></tr>
        ...
        <section className="mt-10">
          <h2 className="text-2xl font-bold text-stone-900">ðŸ½ï¸ Mesas de Jantar 4 Cadeiras - Mais Vendidas</h2>
          <p className="text-sm text-stone-600 mt-1">120-140cm, ideal para ap pequeno. Se sua sala tem menos de 3m, Ã© essa.</p>
          <div className="mt-4"><ProductGrid slugs={MESA_4_CADEIRAS} gridClassName="grid-cols-2 sm:grid-cols-3" /></div>
        </section>

        <section className="mt-10">
          <h2 className="text-2xl font-bold text-stone-900">ðŸ‘¨â€ðŸ‘©â€ðŸ‘§â€ðŸ‘¦ Mesas de Jantar 6 Cadeiras - Para FamÃ­lia</h2>
          <p className="text-sm text-stone-600 mt-1">160-180cm, a mais vendida em MarÃ­lia. 180cm cada pessoa tem 60cm de cotovelo livre.</p>
          <div className="mt-4"><ProductGrid slugs={MESA_6_CADEIRAS} gridClassName="grid-cols-2 sm:grid-cols-3" /></div>
        </section>

        <section className="mt-10">
          <h2 className="text-2xl font-bold text-stone-900">ðŸ³ Tem bancada americana? Use banqueta</h2>
          <p className="text-sm text-stone-600">Se sua cozinha jÃ¡ tem bancada, nÃ£o compre mesa de jantar pequena. Use 2 banquetas altas. Economiza 2mÂ².</p>
        ...
        <section className="mt-12 rounded-3xl bg-stone-900 p-6 text-white">
          ...
          <ol className="mt-4 list-decimal pl-5 space-y-2 text-sm text-stone-300">
            <li><strong className="text-white">Comprar sem medir circulaÃ§Ã£o:</strong> 75cm atrÃ¡s da cadeira. Sem isso nÃ£o levanta da mesa.</li>
            ...
            <li><strong className="text-white">Molhar MDF:</strong> passar pano encharcado estufa borda. Pano Ãºmido sÃ³.</li>
            <li><strong className="text-white">Mesa 6 cadeiras em sala 2,8m:</strong> fica apertada, compra 4 cadeiras retangular 120cm.</li>
            <li><strong className="text-white">Cadeira sem estofado:</strong> cadeira dura de madeira dÃ³i em 30min. Compre estofada 45cm.</li>
          </ol>
        </section>

        <section className="mt-12">
          <h2 className="text-xl font-bold">â“ Perguntas Frequentes</h2>
        ...
        <section className="mt-12 rounded-3xl bg-gradient-to-br from-stone-900 to-stone-800 p-8 text-center text-white">
          ...
          <p className="mt-2 text-stone-300 text-sm">MeÃ§a sua sala: largura - 150cm (75cm cada lado) = tamanho mÃ¡ximo da mesa.</p>
