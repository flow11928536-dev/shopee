...
export default function Page() {
  const jsonLd = {
    ...
    publisher: { "@type": "Organization", name: "Loja de Móveis Marília", logo: { "@type": "ImageObject", url: `${SITE.url}/loja-moveis-jardim-esmeralda-marilia-moveis-de-alto-padrao-marilia-logo.png` } },
      ...
      <article className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="overflow-hidden rounded-[2rem] border border-stone-200 bg-black shadow-sm">
          ...
          <div className="bg-stone-900 px-5 py-3 flex items-center justify-between">
            ...
            <a href="https://www.youtube.com/watch?v=vMsyFy2-BSU" target="_blank" rel="noopener noreferrer" className="rounded-full bg-white px-3 py-1 text-xs font-bold text-black">Ver no YouTube</a>
          </div>
        </section>
        ...
        <section className="mt-10">
          <h2 className="text-2xl font-bold text-stone-900">🍽️ Tem bancada americana? Use banqueta</h2>
