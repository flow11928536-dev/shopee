...
// PÁGINA PRINCIPAL
// ============================================================
export default function MóveisParaEstudantesPage() {
  return (
    <>
      {jsonLd.map((schema, i) => (
      ...
      <article className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section className="mt-12 rounded-2xl border border-stone-200 bg-white p-4 sm:p-6 shadow-sm">
          ...
          <div className="mt-3 flex flex-wrap gap-2 sm:gap-3">
            ...
            <Link href="/montadores/bauru" className="rounded-lg border border-stone-200 px-4 py-2 text-xs font-medium text-stone-700 transition hover:bg-stone-50 sm:px-6 sm:py-2.5 sm:text-sm">Bauru →</Link>
            <Link href="/montadores/botucatu" className="rounded-lg border border-stone-200 px-4 py-2 text-xs font-medium text-stone-700 transition hover:bg-stone-50 sm:px-6 sm:py-2.5 sm:text-sm">Botucatu →</Link>
            <Link href="/montadores/assis" className="rounded-lg border border-stone-200 px-4 py-2 text-xs font-medium text-stone-700 transition hover:bg-stone-50 sm:px-6 sm:py-2.5 sm:text-sm">Assis →</Link>
            <Link href="/montadores/tupa" className="rounded-lg border border-stone-200 px-4 py-2 text-xs font-medium text-stone-700 transition hover:bg-stone-50 sm:px-6 sm:py-2.5 sm:text-sm">Tupã →</Link>
          </div>
        </section>
